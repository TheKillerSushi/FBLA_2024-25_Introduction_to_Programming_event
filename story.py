...
def start_story(): # Starts the story and runs the entirety of it
        ...
        ALL_STORY_BEATS = [
            ["When you arrive at the beach, you see two areas you could photograph. Which one do you want to take a photo of?", ["1 Photograph the crystal blue ocean","BLUE"], ["2 Photograph the beach, the golden sand, pristine and undisturbed","YELLOW"]],
            []
        ]
        ...
        for situation in ALL_STORY_BEATS:
            ...
            choices_made += 1
            all_user_choices[choices_made] = situation[int(user_choice)][1]
